            ...
            <AnimatePresence mode="popLayout">
              {!isAvatar && (
                ...
                <MotionContainer
                  ...
                  className={cn(
                    'relative aspect-square h-[90px] rounded-xl border border-transparent transition-all duration-500',
                    !chatOpen && 'visualizer-glow',
                    chatOpen && 'bg-card border-input/50 shadow-lg delay-200'
                  )}
                >
                  ...
                  <AgentAudioVisualizerBar
                    ...
                    state={agentState}
                    audioTrack={agentAudioTrack}
                    className={cn('flex h-full items-center justify-center gap-1.5 px-4 py-2')}
                  >
                    <span
                      className={cn([
